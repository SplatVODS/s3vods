<script lang="ts">
	...
	// We Post It (Your VOD then gets added to this site with a video preview, title, player name, and tags!)
	// You Search VODS (Filter through many vods using the searchbar!)
</script>
